...
function imcolFromAssetHILDA(startYear, endYear, aoi, dataset) {
  var imageCollection = ee.ImageCollection([]);
  
  for (var year = startYear; year <= endYear; year++) {
    var asset_id = 'projects/mohanrahan/assets/HILDA/clipped_HILDAplus_geotiff_' + dataset + '_' + year.toString() + '_4326';
    var date = ee.Date.fromYMD(year+100, 8, 31).advance(22, 'hour');
...
exports.imcolFromAssetHILDA = imcolFromAssetHILDA;
